...
const COLOR = ['blue.jpg', 'green.jpg', 'yellow.jpg', 'purple.jpg'];
const length = 50;
const RADIUS = 50;
...
function Dino(param) {
    MovingObject.call(this, { word: random_word(), pos: param["pos"], vel: Util.randomVec(5), color: random_item(COLOR), radius: RADIUS, game: param["game"] });
}
